    ...
    <div className="w-full h-full flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="flex gap-3 mt-6">
        ...
        <Link to="/products">
          <button
            onClick={onClose}
            className="bg-black hover:bg-gray-900 text-white px-5 py-2 rounded-lg transition focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-white"
          >
            Continue Shopping
          </button>
        </Link>
